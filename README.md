...
在本作業中，我們透過簡單線性回歸 (Simple Linear Regression, SLR) 來探索 自變數 
𝑋
X 與因變數 
𝑌
Y 之間的線性關係。
...
練習從資料生成到模型擬合、評估的完整流程。

熟悉 CRISP-DM (Cross Industry Standard Process for Data Mining) 方法論：

系統性理解問題、資料、建模與評估流程。

使用互動式 Python 工具 (Streamlit) 觀察模型對不同參數和資料分布的反應。
